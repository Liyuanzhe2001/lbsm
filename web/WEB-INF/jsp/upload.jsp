...
<%--弹窗--%>
<button type="button" style="display: none;" id="excelBtn" name="excelBtn" data-toggle="modal"
        data-target="#warning"></button>
<div class="modal fade" id="warning" tabindex="-1" aria-labelledby="openWarning" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="openWarning" style="font-size: 14px;color: grey;">警告</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="color: black;">确定</button>
                <button type="button" class="btn btn-primary" style="color: black;">
                    <a href="${pageContext.request.contextPath}/home/downloadMouldFile" style="text_decoration: none;">
                        下载模板
                    </a>
                </button>
            </div>
            ...
            <header class="codrops-header" style="height: 800px;">
                <div class="codrops-demos">
                    <form action="${pageContext.request.contextPath}/home/upload" method="post"
                        ...
                        <input id="error" name="error" style="display: none" value="${error}">
                        <label for="input-file-now" style="font-size: 16px">上传你的Excel表格</label>
                        <input type="file" id="input-file-now" class="dropify" data-default-file=""
                               data-max-file-size="3M"
                               accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                               name="file" required="required"/>
                        <br><span class="text" style="color: #ff5040;font-size: 14px;">${msg}</span>
                        <br><input type="submit" id="submitExcel" name="submitExcel" value="提交" class="btn btn-primary">
                        <br><a href="${pageContext.request.contextPath}/home/downloadMouldFile">没有模板？点击下载</a>
                    </form>
                </div>
            </header>
        </div>
