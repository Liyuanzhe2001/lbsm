        ...
        <div class="content">
            <header class="codrops-header" style="height: 800px;">
                <div class="codrops-demos">
                    ...
                    <form method="post">
                        <label>选择学生</label>
                        <select class="form-control form-control-sm" id="studentName" name="studentName">                        <label>选择学生</label>
                        ...
                        <div class="form-group">
                            <label for="studentName">学号</label>
                            <input type="text" class="form-control"
                                   required="required" id="studentId" name="studentId">
                        </div>
                        <div class="form-group">
                            <label for="studentName">身份证号</label>
                            <input type="text" class="form-control"
                                   required="required" id="idNumber" name="idNumber">
                        </div>
                        <br><span class="text" style="color: #ff5040;font-size: 14px;" id="msg"></span>
                        <input type="submit" class="btn btn-primary" onclick="sub()" value="提交">
                    </form>
...
<script>
    ...
    function sub() {
        ...
        if (studentName == "选择学生") {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/changeInfo/modifyStudentInfo",
                data: {
