        ...
        <nav class="menu-side">
            ...
            <div class="collapse" id="changeExcel" style="margin-left: 40px">
                <div class="card card-body" style="font-size: 13px;">
                    ...
                    <a href="${pageContext.request.contextPath}/changeI     nfo/toModifyOneStudent">修改单个学生学分信息</a><br>
                ...
                <div class="codrops-demos">
                    <table class="table" style="color: rgb(59,59,59)">
                        ...
                        <tr>
                            ...
                            <th scope="col">操作学生</th>
                            <th scope="col">操作位置</th>
                        ...
                        <c:forEach var="records" items="${pageInfo.list}">
                            <tr>
                                <td>${records.type}</td>
                                <td>${records.studentName}</td>
                                <td>${records.position}</td>
                                <td>${records.time}</td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/home/delete?id=${records.id}">删除记录</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    ...
                    <div class="row">
                        ...
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/home/records?page=1">&laquo;</a></li>
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                                ...
                                <c:if test="${page!=pageInfo.pageNum}">
                                    <li class="page-item"><a class="page-link"
                                                             href="${pageContext.request.contextPath}/home/records?page=${page}">${page}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/home/records?page=${pageInfo.pages}">&raquo;</a>
                            </li>
                        </ul>
                    </div>
                </div>
